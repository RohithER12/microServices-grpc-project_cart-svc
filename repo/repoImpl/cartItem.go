...
func (c *CartItemImpl) AddItem(item models.CartItems) error {
...
func (c *CartItemImpl) RemoveItem(item models.CartItems) error {
...
func (c *CartItemImpl) GetById(id int64) (models.CartItems, error) {
...
func (c *CartItemImpl) GetByCartId(cartId int64) ([]models.CartItems, error) {
...
func (c *CartItemImpl) RemoveOne(item models.CartItems) error {
...
func (c *CartItemImpl) GetByCartIdAndProductId(cartId, productId int64) (models.CartItems, error) {
	var item models.CartItems
